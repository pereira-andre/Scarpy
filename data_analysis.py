...
class DataAnalysisBase(ABC):
    ...
    def add_data(self, data, replace=False, csv_path=None):
        ...
        if csv_path:
            ...
            raise TypeError("data deve ser um DataFrame ou None se csv_path for fornecido.")
...
class StandardReportGenerator(ReportGeneratorBase):
    ...
    def generate_html_report(self, filtered_data):
        ...
        with open("standard_report.html", "w") as file:
            file.write(html_content)
        return "standard_report.html"
...
class DetailedReportGenerator(ReportGeneratorBase):
    ...
    def generate_html_report(self, filtered_data):
        ...
        with open("detailed_report.html", "w") as file:
            file.write(html_content)
        return "detailed_report.html"
