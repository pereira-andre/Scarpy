...
from scraping.scraper_controller import ScraperController
from analysis.data_analysis import StandardReportGenerator, DetailedReportGenerator
...
class MainGUI:
    ...
    def create_csv_input_section(self):
        ...
        self.csv_entry_var = tk.StringVar(value=csv_file_path)
    ...
    def create_report_config_section(self):
        ...
        if self.csv_file:
            if detailed_report:
                ...
                report_gen = StandardReportGenerator(self.csv_file)
        else:
    ...
    def generate_custom_report(self):
        ...
        if detailed_report:
            report_gen = DetailedReportGenerator(csv_file)
        else:
            report_gen = StandardReportGenerator(csv_file)
    ...
    def create_config_elements(self):
        ...
        self.price_selector_entry.insert(
            0,
            config.get(
                "PriceSelector", "h3.offer-price__number.eqdspoq4.ooa-o7wv9s.er34gjf0"
            ),
        )
    ...
    def save_config(self):
        ...
        try:
            with open(config_path, "w") as config_file:
                ...
                config_file.write(
                    f"OthersSelector:{self.others_selector_entry.get()}\n"
                )
